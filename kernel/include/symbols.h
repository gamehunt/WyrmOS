...
#define EXPORT_INTERNAL(func) __attribute__((used, section(".kernel_exported"))) \
	static const symbol __export_##func = {.name = #func, .address = (uintptr_t) &func, .internal = 1, .pad = 0};
#else
